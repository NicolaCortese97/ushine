...
<style>
    ...
    [data-theme="dark"] .settings-menu-item:hover svg,
    [data-theme="dark"] .settings-menu-item:hover span {
        color: #8fa3ff !important;
    }
    ...
    .settings-logout-item:hover span {
        color: #ef4444 !important;
    }

    [data-theme="dark"] .settings-logout-item:hover {
        background-color: rgba(239, 68, 68, 0.15) !important;
        color: #fca5a5 !important;
    }
    [data-theme="dark"] .settings-logout-item:hover svg,
    [data-theme="dark"] .settings-logout-item:hover span {
        color: #fca5a5 !important;
    }
</style>
...
<div class="min-h-screen bg-base-100 font-sans text-base-content">
    ...
    <header class="bg-base-100 border-b border-base-200 sticky top-0 z-50" style="height: 64px; line-height: 64px;">
        <div class="max-w-full mx-auto px-4" style="height: 100%; display: flex; align-items: center; justify-content: space-between; position: relative;">
            ...
            <div style="display: flex; align-items: center; height: 100%;">
                <a href="{{ route('homepage') }}" class="hover:bg-base-200" style="display: inline-flex; align-items: center; justify-content: center; width: 40px; height: 40px; border-radius: 50%; transition: background-color 0.2s ease; text-decoration: none; color: inherit;">
            ...
            <div style="position: absolute; left: 50%; top: 50%; transform: translate(-50%, -50%); pointer-events: none; max-width: 60%; width: auto; display: flex; align-items: center; justify-content: center; height: 100%;">
                <h1 class="text-xl font-bold" style="margin: 0; padding: 0; line-height: 1; text-align: center; white-space: nowrap; overflow: hidden; text-overflow: ellipsis; pointer-events: auto;">{{ __('Settings') }}</h1>
            </div>
    ...
    <main class="max-w-full mx-auto px-4 py-6">
        ...
        <!-- Apparence -->
        <section class="mb-6">
            <h2 class="text-xs font-bold text-base-content/60 uppercase tracking-wider mb-1 px-2">{{ __('Appearance') }}</h2>
            <div class="bg-base-200 rounded-xl overflow-hidden">
                <div class="flex items-center justify-between p-4">
                    <div class="flex items-center gap-3">
                        ...
                        <span class="font-medium text-[15px]">{{ __('Dark Mode') }}</span>
                    </div>
        ...
        <!-- Account -->
        <section class="mb-6">
            <h2 class="text-xs font-bold text-base-content/60 uppercase tracking-wider mb-1 px-2">{{ __('Account') }}</h2>
            <div class="bg-base-200 rounded-xl overflow-hidden">
                <a href="{{ route('settings.profile.edit') }}" class="settings-menu-item flex items-center justify-between p-4 hover:bg-base-300 transition-colors">
                    <div class="flex items-center gap-3">
                        ...
                        <span class="font-medium text-[15px]">{{ __('Edit Profile') }}</span>
                    </div>
        ...
        <!-- Privacy & Security -->
        <section class="mb-6">
            <h2 class="text-xs font-bold text-base-content/60 uppercase tracking-wider mb-1 px-2">{{ __('Privacy & Security') }}</h2>
            <div class="bg-base-200 rounded-xl overflow-hidden">
                <a href="{{ route('settings.privacy') }}" class="settings-menu-item flex items-center justify-between p-4 hover:bg-base-300 transition-colors">
                    <div class="flex items-center gap-3">
                        ...
                        <span class="font-medium text-[15px]">{{ __('Privacy & Security') }}</span>
                    </div>
                    <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 text-base-content/40" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M9 5l7 7-7 7" /></svg>
                </a>
            </div>
        ...
        <!-- Notifications -->
        <section class="mb-6">
            <h2 class="text-xs font-bold text-base-content/60 uppercase tracking-wider mb-1 px-2">{{ __('Notifications') }}</h2>
            <div class="bg-base-200 rounded-xl overflow-hidden">
                <a href="{{ route('settings.notifications') }}" class="settings-menu-item flex items-center justify-between p-4 hover:bg-base-300 transition-colors">
                    <div class="flex items-center gap-3">
                        <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6 text-base-content" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5"><path stroke-linecap="round" stroke-linejoin="round" d="M15 17h5l-1.405-1.405A2.032 2.032 0 0118 14.158V11a6.002 6.002 0 00-4-5.659V5a2 2 0 10-4 0v.341C7.67 6.165 6 8.388 6 11v3.159c0 .538-.214 1.055-.595 1.436L4 17h5m6 0v1a3 3 0 11-6 0v-1m6 0H9" /></svg>
                        <span class="font-medium text-[15px]">{{ __('Notifications') }}</span>
                    </div>
                    <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 text-base-content/40" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M9 5l7 7-7 7" /></svg>
                </a>
            </div>
        ...
        <!-- Support -->
        <section class="mb-6">
            <h2 class="text-xs font-bold text-base-content/60 uppercase tracking-wider mb-1 px-2">{{ __('Support') }}</h2>
            <div class="bg-base-200 rounded-xl overflow-hidden">
                <a href="{{ route('settings.support') }}" class="settings-menu-item flex items-center justify-between p-4 hover:bg-base-300 transition-colors">
                    <div class="flex items-center gap-3">
                        <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6 text-base-content" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5"><path stroke-linecap="round" stroke-linejoin="round" d="M8.228 9c.549-1.165 2.03-2 3.772-2 2.21 0 4 1.343 4 3 0 1.4-1.278 2.575-3.006 2.907-.542.104-.994.54-.994 1.093m0 3h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>
                        <span class="font-medium text-[15px]">{{ __('Help & Support') }}</span>
                    </div>
                    <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 text-base-content/40" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M9 5l7 7-7 7" /></svg>
                </a>
            </div>
        ...
        <!-- Danger zone -->
        <section class="mb-8">
            <h2 class="text-xs font-bold text-error uppercase tracking-wider mb-1 px-2">{{ __('Danger zone') }}</h2>
            <div class="bg-base-200 rounded-xl overflow-hidden">
                <form action="{{ route('logout') }}" method="POST" id="logout-form">
                    @csrf
                    <button type="submit" class="settings-logout-item w-full flex items-center justify-between p-4 hover:bg-base-300 transition-colors text-error cursor-pointer">
                        <div class="flex items-center gap-3">
