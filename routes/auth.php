...
Route::middleware(['auth'])->group(function () {
    ...
    Route::post('settings/profile/photo', [Settings\ProfileController::class, 'updatePhoto'])->name('settings.profile.photo.update');
    Route::delete('settings/profile/photo', [Settings\ProfileController::class, 'removePhoto'])->name('settings.profile.photo.destroy');
